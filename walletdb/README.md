...
[![GoDoc](https://godoc.org/github.com/stroomnetwork/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/stroomnetwork/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/stroomnetwork/btcwallet/walletdb

## Installation

```bash
$ go get github.com/stroomnetwork/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/stroomnetwork/btcwallet/walletdb#example-package--BasicUsage)  
